  ...
  const handleSubmit = async (e: React.FormEvent, statusOverride?: string) => {
    ...
    try {
      ...
      const tripData = {
        ...
        total_seats: parseInt(form.totalSeats) || undefined,
        seats_left: parseInt(form.seatsLeft) || undefined,
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#e7e1d5]/50 pb-5">
        <div className="text-left flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-display font-extrabold text-nomichi-ink tracking-tight">Add New Trip</h1>
            <p className="text-xs text-nomichi-ink/40 font-semibold mt-1">
              Create a new trip template and publish or keep it as a draft.
            </p>
          </div>
        </div>
